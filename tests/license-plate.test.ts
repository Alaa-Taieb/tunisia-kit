...
describe('isValidLicensePlate', () => {
  describe('valid license plates', () => {
    ...
    it('accepts diplomatic corps (CD) plates', () => {
      expect(isValidLicensePlate('12 CD 34')).toBe(true);
      expect(isValidLicensePlate('12CD34')).toBe(true);
    });

    it('accepts resident secondaire / rental (RS) plates', () => {
