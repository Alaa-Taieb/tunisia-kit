...
describe('isValidIBAN', () => {
  ...
  describe('invalid IBANs', () => {
    ...
    it('rejects non-digit characters after TN', () => {
      expect(isValidIBAN('TNX910005000000000000049')).toBe(false);
    });
...
describe('formatIBAN', () => {
  it('formats IBAN in groups of 4', () => {
    expect(formatIBAN('TN5910005000000000000049')).toBe('TN59 1000 5000 0000 0000 0049');
  });
  ...
  it('handles already spaced input', () => {
    expect(formatIBAN('TN59 1000 5000 0000 0000 0049')).toBe('TN59 1000 5000 0000 0000 0049');
  });
